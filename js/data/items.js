...
export const ITEMS_DATA = {
    ...
    sp_orb_small: { id: "sp_orb_small", name: "Small SP Orb", type: "consumable", description: "Grants 10 Study Points. Use outside combat.", rarity: "uncommon", value: 0, stackable: true, icon: "🔮", use_effect: { type: "grant_sp", target: "non_combat", amount: 10 } },
    sp_orb_medium: { id: "sp_orb_medium", name: "Medium SP Orb", type: "consumable", description: "Grants 50 Study Points. Use outside combat.", rarity: "rare", value: 0, stackable: true, icon: "🔮", use_effect: { type: "grant_sp", target: "non_combat", amount: 50 } },
    ...
    w003: { id: "w003", name: "Hunter's Bow", type: "weapon", slot: "twoHand", description: "A sturdy bow crafted for hunting. Requires both hands.", rarity: "uncommon", value: 50, icon: "🏹",
            stats: { attack: 10, dex: 3 } },
    w010_primal_club: { id: "w010_primal_club", name: "Primal Club", type: "weapon", slot: "weapon", description: "A heavy club fashioned from ancient wood and stone, wielded by Sansan.", rarity: "legendary", value: 0, icon: "🪵", // Using wood log icon
    ...
    r002_engagement_ring_sansan: {
        ...
        scalingStats: { // Stats that increase per player level
            levelFactor: 1, // How many player levels per bonus point
...
export const STARTING_ITEMS = {
    ...
    rogue: [{itemId: "w001", quantity: 1}, {itemId: "a001", quantity: 1}, {itemId: "c001", quantity: 2}]
};

export const EQUIPMENT_SLOTS = {
    // Define slots specifically for player and allies
    player: ["weapon", "offHand", "head", "body", "hands", "feet", "accessory1", "accessory2"],
    sansan_dino: ["weapon", "body", "accessory1"] // Sansan can equip a weapon, body armor, and one accessory
};
